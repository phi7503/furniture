    ...
    <body>
        <div id="logreg-forms">
            ...
            <form action="signup" class="form-signup">
                ...
                <input type="text" id="adress" class="form-control" placeholder="Adress" required autofocus="" name="adress">
                <input type="text" id="phone" class="form-control" placeholder="Phone Number" required autofocus="" name="phone">
